...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_distributed_database_distributed_autonomous_database_raft_metric", DistributedDatabaseDistributedAutonomousDatabaseRaftMetricDataSource)
	...
	tfresource.RegisterDatasource("oci_distributed_database_distributed_database_raft_metric", DistributedDatabaseDistributedDatabaseRaftMetricDataSource)
