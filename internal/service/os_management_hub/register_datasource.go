...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_os_management_hub_profile_available_software_sources", OsManagementHubProfileAvailableSoftwareSourcesDataSource)
	tfresource.RegisterDatasource("oci_os_management_hub_profile_version", OsManagementHubProfileVersionDataSource)
	...
	tfresource.RegisterDatasource("oci_os_management_hub_software_source_available_software_packages", OsManagementHubSoftwareSourceAvailableSoftwarePackagesDataSource)
	tfresource.RegisterDatasource("oci_os_management_hub_software_source_manifest", OsManagementHubSoftwareSourceManifestDataSource)
