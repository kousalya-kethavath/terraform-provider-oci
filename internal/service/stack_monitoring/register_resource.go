...
func RegisterResource() {
	...
	tfresource.RegisterResource("oci_stack_monitoring_monitoring_template", StackMonitoringMonitoringTemplateResource)
	tfresource.RegisterResource("oci_stack_monitoring_monitoring_template_alarm_condition", StackMonitoringMonitoringTemplateAlarmConditionResource)
	tfresource.RegisterResource("oci_stack_monitoring_monitoring_template_monitoring_template_on_given_resources_management", StackMonitoringMonitoringTemplateMonitoringTemplateOnGivenResourcesManagementResource)
