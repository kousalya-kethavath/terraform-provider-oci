...
func RegisterDatasource() {
	tfresource.RegisterDatasource("oci_database_management_cloud_asm", DatabaseManagementCloudAsmDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_asm_configuration", DatabaseManagementCloudAsmConfigurationDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_asm_disk_groups", DatabaseManagementCloudAsmDiskGroupsDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_asm_instance", DatabaseManagementCloudAsmInstanceDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_asm_instances", DatabaseManagementCloudAsmInstancesDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_asm_users", DatabaseManagementCloudAsmUsersDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_asms", DatabaseManagementCloudAsmsDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_cluster", DatabaseManagementCloudClusterDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_cluster_instance", DatabaseManagementCloudClusterInstanceDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_cluster_instances", DatabaseManagementCloudClusterInstancesDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_clusters", DatabaseManagementCloudClustersDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_databases", DatabaseManagementCloudDatabasesDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_db_home", DatabaseManagementCloudDbHomeDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_db_homes", DatabaseManagementCloudDbHomesDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_db_node", DatabaseManagementCloudDbNodeDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_db_nodes", DatabaseManagementCloudDbNodesDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_db_system", DatabaseManagementCloudDbSystemDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_db_system_connector", DatabaseManagementCloudDbSystemConnectorDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_db_system_connectors", DatabaseManagementCloudDbSystemConnectorsDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_db_system_discoveries", DatabaseManagementCloudDbSystemDiscoveriesDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_db_system_discovery", DatabaseManagementCloudDbSystemDiscoveryDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_db_systems", DatabaseManagementCloudDbSystemsDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_listener", DatabaseManagementCloudListenerDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_listener_services", DatabaseManagementCloudListenerServicesDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_listeners", DatabaseManagementCloudListenersDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_exadata_infrastructure", DatabaseManagementCloudExadataInfrastructureDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_exadata_infrastructures", DatabaseManagementCloudExadataInfrastructuresDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_exadata_storage_connector", DatabaseManagementCloudExadataStorageConnectorDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_exadata_storage_connectors", DatabaseManagementCloudExadataStorageConnectorsDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_exadata_storage_grid", DatabaseManagementCloudExadataStorageGridDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_exadata_storage_server", DatabaseManagementCloudExadataStorageServerDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_exadata_storage_server_iorm_plan", DatabaseManagementCloudExadataStorageServerIormPlanDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_exadata_storage_server_open_alert_history", DatabaseManagementCloudExadataStorageServerOpenAlertHistoryDataSource)
	tfresource.RegisterDatasource("oci_database_management_cloud_exadata_storage_servers", DatabaseManagementCloudExadataStorageServersDataSource)
	...
	tfresource.RegisterDatasource("oci_database_management_exadata_infrastructure_fleet_metric", DatabaseManagementExadataInfrastructureFleetMetricDataSource)
	...
	tfresource.RegisterDatasource("oci_database_management_managed_my_sql_database_binary_log_information", DatabaseManagementManagedMySqlDatabaseBinaryLogInformationDataSource)
	...
	tfresource.RegisterDatasource("oci_database_management_managed_my_sql_database_digest_errors", DatabaseManagementManagedMySqlDatabaseDigestErrorsDataSource)
	tfresource.RegisterDatasource("oci_database_management_managed_my_sql_database_general_replication_information", DatabaseManagementManagedMySqlDatabaseGeneralReplicationInformationDataSource)
	tfresource.RegisterDatasource("oci_database_management_managed_my_sql_database_high_availability_members", DatabaseManagementManagedMySqlDatabaseHighAvailabilityMembersDataSource)
	tfresource.RegisterDatasource("oci_database_management_managed_my_sql_database_inbound_replications", DatabaseManagementManagedMySqlDatabaseInboundReplicationsDataSource)
	tfresource.RegisterDatasource("oci_database_management_managed_my_sql_database_outbound_replications", DatabaseManagementManagedMySqlDatabaseOutboundReplicationsDataSource)
	tfresource.RegisterDatasource("oci_database_management_managed_my_sql_database_query_detail", DatabaseManagementManagedMySqlDatabaseQueryDetailDataSource)
